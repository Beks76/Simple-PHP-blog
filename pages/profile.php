...
<?php include '../views/head_p.php' ?>
    ...
    <div class="container">
        <input type="text" id="user_data" class="none" user_id=<?php echo $user['id'] ?>>
        <div class="span3 well mt-4">
            <center>
                ...
                <a href="edit_profile.php" class="btn">Edit a profile</a>
            </center>
            <div class="post none">
                    <center>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="decsr" name="descr" placeholder="Description(maximum 100 symbols)" rows="3"></textarea>
                        </div>
                        <div class="form-group">
